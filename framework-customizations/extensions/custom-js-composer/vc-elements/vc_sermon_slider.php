  ...
  <div class="vc-custom-inner-wrap">
	...
	if(count($posts_data) > 0):
		foreach($posts_data as $item) {
			...
			$terms_sm = get_the_terms( $item['post_id'], 'ctc_sermon_speaker' ); 
			$video_sm = get_post_meta($item['post_id'], '_ctc_sermon_video', true);
	...
	<!-- modal -->
	<div class="modal fade" id="<?php echo sprintf('sm-modal-media-%s', $rand_id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-semon-modal>
