 ...
 * ----- Custom -------
 * @var $custom_letter_spacing
 * Shortcode class
 * @var $this WPBakeryShortCode_VC_Custom_heading
 */
$source = $text = $link = $google_fonts = $font_container = $el_id = $el_class = $css = $css_animation = $font_container_data = $google_fonts_data = $custom_letter_spacing = '';
...
/* custom params */
if(! empty($custom_letter_spacing)) {
  $styles = ! empty( $styles ) ? $styles : array();
  $styles[] = "letter-spacing: {$custom_letter_spacing}";
}
