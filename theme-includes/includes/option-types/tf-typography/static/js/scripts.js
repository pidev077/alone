/*global fw_tf_typography_fonts, jQuery, _ */
( function ($) {

    $(document).ready(function () {
        var optionTypeClass = '.fw-option-type-tf-typography',
            googleFonts = JSON.parse(fw_tf_typography_fonts['google']),
            /**
            ...
            getFontsOptions = function () {
                if (fontsOptions === null) {
                    ...
                    _.each(fw_tf_typography_fonts['standard'], function (item) {
        ...
        fwEvents.on('fw:options:init', function (data) {
            data.$elements.find(optionTypeClass + ':not(.initialized)').each(function () {
                ...
                $option.find([
                    '.fw-option-tf-typography-option .fw-option-tf-typography-option-size-input',
                    '.fw-option-tf-typography-option .fw-option-tf-typography-option-line-height-input',
                    '.fw-option-tf-typography-option .fw-option-tf-typography-option-letter-spacing-input'
                ...
                {
                    var $fontFamilySelect = $option.find('.fw-option-tf-typography-option-family select[data-type="family"]');
                    ...
                    $fontFamilySelect
                        ...
                        .selectize({
                            onChange: function (selected) {
                                ...
                                var $variations = this.$dropdown.closest(optionTypeClass).find('.fw-option-tf-typography-option-variation');
                                var $subsets = this.$dropdown.closest(optionTypeClass).find('.fw-option-tf-typography-option-subset');

                                var $style = this.$dropdown.closest(optionTypeClass).find('.fw-option-tf-typography-option-style');
                                var $weight = this.$dropdown.closest(optionTypeClass).find('.fw-option-tf-typography-option-weight');
